                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      if (state.data!.userResponse != null ||
                                          state.data!.userResponse?.data!
                                                  .dateOfBirth !=
                                              null)
                                        Text(
                                          '${state.data!.userResponse!.data?.dateOfBirth?.day}/${state.data!.userResponse!.data?.dateOfBirth?.month}/${state.data!.userResponse!.data?.dateOfBirth?.year}',
                                          style: const TextStyle(
                                              fontSize: 14,
                                              fontWeight: FontWeight.w400,
                                              fontFamily: 'Inter'),
